...
public class AudioFileUtils
{
  ...
  public static AudioInputStream readMP3AsMono( File file )
		    throws IOException
		  {
		      ...
		      InputStream mixed = new InputStream()
		      {
		        ...
		        public int read() throws IOException
		        {
		          ...
		          this.length = din.read(this.monobuf);
		          if (this.length <= 0) {
		      ...
		      return new AudioInputStream(mixed, desiredFormat, din.getFrameLength());
	}
