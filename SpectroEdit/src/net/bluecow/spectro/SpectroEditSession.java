...
/*     */
/*  82 */     final JFrame f = new JFrame("Spectro-Edit ME");
...
/* 160 */     final JFrame f = new JFrame("Dummy frame for owning dialogs");
/* 161 */     SwingUtilities.invokeLater(new Runnable() {
/*     */       public void run() {
/*     */         try {
/* 164 */           FileDialog fd = new FileDialog(f, "Choose a 16-bit WAV or AIFF file");
/* 165 */           fd.setVisible(true);
/* 166 */           String dir = fd.getDirectory();
/* 167 */           String file = fd.getFile();
/* 168 */           if ((dir == null) || (file == null)) {
/* 169 */             JOptionPane.showMessageDialog(null, "Ok, maybe next time");
/* 170 */             System.exit(0);
/*     */           }
...
/* 176 */           JOptionPane.showMessageDialog(null, "Sorry, couldn't read your sample:\n" + e.getMessage() + "\nBe sure your file is 16-bit WAV or AIFF!");
/*     */
/* 180 */           System.exit(0);
/*     */         }
/*     */       }
