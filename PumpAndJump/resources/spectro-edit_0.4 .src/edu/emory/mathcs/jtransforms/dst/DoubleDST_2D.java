...
public class DoubleDST_2D
{
  ...
  public DoubleDST_2D(int paramInt1, int paramInt2)
  {
    ...
    this.dstn2 = new DoubleDST_1D(paramInt2, this.ip, this.w);
    this.dstn1 = new DoubleDST_1D(paramInt1, this.ip, this.w);
  ...
  public void forward(double[] paramArrayOfDouble, boolean paramBoolean)
  {
    ...
    else
    {
      ...
      for (int n = 0; n < this.n1; n++)
        this.dstn2.forward(paramArrayOfDouble, n * this.n2, paramBoolean);
    }
  }
  ...
  public void forward(double[][] paramArrayOfDouble, boolean paramBoolean)
  {
    ...
    else
    {
      ddxt2d_sub(-1, paramArrayOfDouble, paramBoolean);
      for (int n = 0; n < this.n1; n++)
        this.dstn2.forward(paramArrayOfDouble[n], paramBoolean);
    }
  }
  ...
  public void inverse(double[] paramArrayOfDouble, boolean paramBoolean)
  {
    ...
    else
    {
      ddxt2d_sub(1, paramArrayOfDouble, paramBoolean);
      for (int n = 0; n < this.n1; n++)
        this.dstn2.inverse(paramArrayOfDouble, n * this.n2, paramBoolean);
    }
  }
  ...
  public void inverse(double[][] paramArrayOfDouble, boolean paramBoolean)
  {
    ...
    else
    {
      ddxt2d_sub(1, paramArrayOfDouble, paramBoolean);
      for (int n = 0; n < this.n1; n++)
        this.dstn2.inverse(paramArrayOfDouble[n], paramBoolean);
    }
  }
    ...
    for (int k = 0; k < i; k++)
    {
      ...
      arrayOfFuture[k] = ConcurrencyUtils.threadPool.submit(new Runnable()
      {
        public void run()
        {
          ...
          int k;
          int m;
          if (DoubleDST_2D.this.n2 > 2 * n)
          {
            if (paramInt == -1)
            {
              j = 4 * i1;
              while (j < DoubleDST_2D.this.n2)
              {
                for (i = 0; i < DoubleDST_2D.this.n1; i++)
                {
                  k = i * DoubleDST_2D.this.n2 + j;
                  m = i2 + DoubleDST_2D.this.n1 + i;
                  DoubleDST_2D.this.t[(i2 + i)] = paramArrayOfDouble[k];
                  DoubleDST_2D.this.t[m] = paramArrayOfDouble[(k + 1)];
                  DoubleDST_2D.this.t[(m + DoubleDST_2D.this.n1)] = paramArrayOfDouble[(k + 2)];
                  DoubleDST_2D.this.t[(m + 2 * DoubleDST_2D.this.n1)] = paramArrayOfDouble[(k + 3)];
                }
                DoubleDST_2D.this.dstn1.forward(DoubleDST_2D.this.t, i2, paramBoolean);
                DoubleDST_2D.this.dstn1.forward(DoubleDST_2D.this.t, i2 + DoubleDST_2D.this.n1, paramBoolean);
                DoubleDST_2D.this.dstn1.forward(DoubleDST_2D.this.t, i2 + 2 * DoubleDST_2D.this.n1, paramBoolean);
                DoubleDST_2D.this.dstn1.forward(DoubleDST_2D.this.t, i2 + 3 * DoubleDST_2D.this.n1, paramBoolean);
                for (i = 0; i < DoubleDST_2D.this.n1; i++)
                {
                  k = i * DoubleDST_2D.this.n2 + j;
                  m = i2 + DoubleDST_2D.this.n1 + i;
                  paramArrayOfDouble[k] = DoubleDST_2D.this.t[(i2 + i)];
                  paramArrayOfDouble[(k + 1)] = DoubleDST_2D.this.t[m];
                  paramArrayOfDouble[(k + 2)] = DoubleDST_2D.this.t[(m + DoubleDST_2D.this.n1)];
                  paramArrayOfDouble[(k + 3)] = DoubleDST_2D.this.t[(m + 2 * DoubleDST_2D.this.n1)];
                }
                j += 4 * n;
              }
            }
            ...
            while (j < DoubleDST_2D.this.n2)
            {
              ...
              DoubleDST_2D.this.dstn1.inverse(DoubleDST_2D.this.t, i2, paramBoolean);
              DoubleDST_2D.this.dstn1.inverse(DoubleDST_2D.this.t, i2 + DoubleDST_2D.this.n1, paramBoolean);
              DoubleDST_2D.this.dstn1.inverse(DoubleDST_2D.this.t, i2 + 2 * DoubleDST_2D.this.n1, paramBoolean);
              DoubleDST_2D.this.dstn1.inverse(DoubleDST_2D.this.t, i2 + 3 * DoubleDST_2D.this.n1, paramBoolean);
              for (i = 0; i < DoubleDST_2D.this.n1; i++)
              {
                k = i * DoubleDST_2D.this.n2 + j;
                m = i2 + DoubleDST_2D.this.n1 + i;
          ...
          if (DoubleDST_2D.this.n2 == 2 * n)
          {
            for (i = 0; i < DoubleDST_2D.this.n1; i++)
            {
              k = i * DoubleDST_2D.this.n2 + 2 * i1;
              m = i2 + i;
              DoubleDST_2D.this.t[m] = paramArrayOfDouble[k];
              DoubleDST_2D.this.t[(m + DoubleDST_2D.this.n1)] = paramArrayOfDouble[(k + 1)];
            }
            if (paramInt == -1)
            {
              DoubleDST_2D.this.dstn1.forward(DoubleDST_2D.this.t, i2, paramBoolean);
            ...
            for (i = 0; i < DoubleDST_2D.this.n1; i++)
            {
              k = i * DoubleDST_2D.this.n2 + 2 * i1;
              m = i2 + i;
              paramArrayOfDouble[k] = DoubleDST_2D.this.t[m];
              paramArrayOfDouble[(k + 1)] = DoubleDST_2D.this.t[(m + DoubleDST_2D.this.n1)];
            }
          }
          if (DoubleDST_2D.this.n2 == n)
          {
            for (i = 0; i < DoubleDST_2D.this.n1; i++)
              DoubleDST_2D.this.t[(i2 + i)] = paramArrayOfDouble[(i * DoubleDST_2D.this.n2 + i1)];
            if (paramInt == -1)
              DoubleDST_2D.this.dstn1.forward(DoubleDST_2D.this.t, i2, paramBoolean);
            else
              DoubleDST_2D.this.dstn1.inverse(DoubleDST_2D.this.t, i2, paramBoolean);
            for (i = 0; i < DoubleDST_2D.this.n1; i++)
              paramArrayOfDouble[(i * DoubleDST_2D.this.n2 + i1)] = DoubleDST_2D.this.t[(i2 + i)];
          }
        }
      });
    }
      ...
      arrayOfFuture[k] = ConcurrencyUtils.threadPool.submit(new Runnable()
      {
        public void run()
        {
          ...
          if (DoubleDST_2D.this.n2 > 2 * n)
          {
            if (paramInt == -1)
            {
              ...
              while (j < DoubleDST_2D.this.n2)
              {
                for (i = 0; i < DoubleDST_2D.this.n1; i++)
                {
                  k = i2 + DoubleDST_2D.this.n1 + i;
                  DoubleDST_2D.this.t[(i2 + i)] = paramArrayOfDouble[i][j];
                  DoubleDST_2D.this.t[k] = paramArrayOfDouble[i][(j + 1)];
                  DoubleDST_2D.this.t[(k + DoubleDST_2D.this.n1)] = paramArrayOfDouble[i][(j + 2)];
                  DoubleDST_2D.this.t[(k + 2 * DoubleDST_2D.this.n1)] = paramArrayOfDouble[i][(j + 3)];
                }
                DoubleDST_2D.this.dstn1.forward(DoubleDST_2D.this.t, i2, paramBoolean);
                DoubleDST_2D.this.dstn1.forward(DoubleDST_2D.this.t, i2 + DoubleDST_2D.this.n1, paramBoolean);
                DoubleDST_2D.this.dstn1.forward(DoubleDST_2D.this.t, i2 + 2 * DoubleDST_2D.this.n1, paramBoolean);
                ...
                {
                  k = i2 + DoubleDST_2D.this.n1 + i;
                  paramArrayOfDouble[i][j] = DoubleDST_2D.this.t[(i2 + i)];
                  paramArrayOfDouble[i][(j + 1)] = DoubleDST_2D.this.t[k];
                  paramArrayOfDouble[i][(j + 2)] = DoubleDST_2D.this.t[(k + DoubleDST_2D.this.n1)];
                  paramArrayOfDouble[i][(j + 3)] = DoubleDST_2D.this.t[(k + 2 * DoubleDST_2D.this.n1)];
                }
                j += 4 * n;
              }
            }
          ...
          if (DoubleDST_2D.this.n2 == 2 * n)
          {
            ...
            {
              k = i2 + i;
              DoubleDST_2D.this.t[k] = paramArrayOfDouble[i][(2 * i1)];
              DoubleDST_2D.this.t[(k + DoubleDST_2D.this.n1)] = paramArrayOfDouble[i][(2 * i1 + 1)];
            }
            if (paramInt == -1)
            {
              DoubleDST_2D.this.dstn1.forward(DoubleDST_2D.this.t, i2, paramBoolean);
            ...
            {
              k = i2 + i;
              paramArrayOfDouble[i][(2 * i1)] = DoubleDST_2D.this.t[k];
              paramArrayOfDouble[i][(2 * i1 + 1)] = DoubleDST_2D.this.t[(k + DoubleDST_2D.this.n1)];
            }
          }
          if (DoubleDST_2D.this.n2 == n)
          {
            for (i = 0; i < DoubleDST_2D.this.n1; i++)
              DoubleDST_2D.this.t[(i2 + i)] = paramArrayOfDouble[i][i1];
            if (paramInt == -1)
              DoubleDST_2D.this.dstn1.forward(DoubleDST_2D.this.t, i2, paramBoolean);
            else
              DoubleDST_2D.this.dstn1.inverse(DoubleDST_2D.this.t, i2, paramBoolean);
            for (i = 0; i < DoubleDST_2D.this.n1; i++)
              paramArrayOfDouble[i][i1] = DoubleDST_2D.this.t[(i2 + i)];
          }
        }
      });
    }
    ...
    for (int j = 0; j < i; j++)
    {
      ...
      arrayOfFuture[j] = ConcurrencyUtils.threadPool.submit(new Runnable()
      {
        public void run()
        {
          ...
          {
            i = m;
            while (i < DoubleDST_2D.this.n1)
            {
              DoubleDST_2D.this.dstn2.forward(paramArrayOfDouble, i * DoubleDST_2D.this.n2, paramBoolean);
              i += i;
            }
          }
          else
          {
            ...
            while (i < DoubleDST_2D.this.n1)
            {
              DoubleDST_2D.this.dstn2.inverse(paramArrayOfDouble, i * DoubleDST_2D.this.n2, paramBoolean);
              i += i;
            }
          }
        }
      ...
      arrayOfFuture[j] = ConcurrencyUtils.threadPool.submit(new Runnable()
      {
        public void run()
        {
          ...
          if (paramInt == -1)
          {
            ...
            while (i < DoubleDST_2D.this.n1)
            {
              DoubleDST_2D.this.dstn2.forward(paramArrayOfDouble[i], paramBoolean);
              i += i;
            }
          }
          else
          {
            ...
            while (i < DoubleDST_2D.this.n1)
            {
              DoubleDST_2D.this.dstn2.inverse(paramArrayOfDouble[i], paramBoolean);
              i += i;
            }
          }
        }
 ...
 * Qualified Name:     edu.emory.mathcs.jtransforms.dst.DoubleDST_2D
