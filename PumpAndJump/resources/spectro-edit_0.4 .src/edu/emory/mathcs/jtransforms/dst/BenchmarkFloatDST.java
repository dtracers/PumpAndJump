...
public class BenchmarkFloatDST
{
  ...
  public static void benchmarkForward_1D(int paramInt)
  {
    ...
    for (int i = 0; i < nsize; i++)
    {
      ...
      if (doWarmup)
      {
        ...
        localFloatDST_1D.forward(arrayOfFloat, false);
        IOUtils.fillMatrix_1D(k, arrayOfFloat);
        localFloatDST_1D.forward(arrayOfFloat, false);
      }
      float f = 0.0F;
    ...
    IOUtils.writeFFTBenchmarkResultsToFile("benchmarkFloatForwardDST_1D.txt", nthread, niter, doWarmup, doScaling, arrayOfInt, arrayOfDouble);
  }
  ...
  public static void benchmarkForward_2D_input_1D(int paramInt)
  {
    ...
    for (int i = 0; i < nsize; i++)
    {
      ...
      FloatDST_2D localFloatDST_2D = new FloatDST_2D(k, k);
      float[] arrayOfFloat = new float[k * k];
      if (doWarmup)
      {
        IOUtils.fillMatrix_2D(k, k, arrayOfFloat);
        localFloatDST_2D.forward(arrayOfFloat, false);
        IOUtils.fillMatrix_2D(k, k, arrayOfFloat);
        localFloatDST_2D.forward(arrayOfFloat, false);
      }
      float f = 0.0F;
    ...
    IOUtils.writeFFTBenchmarkResultsToFile("benchmarkFloatForwardDST_2D_input_1D.txt", nthread, niter, doWarmup, doScaling, arrayOfInt, arrayOfDouble);
  }
  ...
  public static void benchmarkForward_2D_input_2D(int paramInt)
  {
    ...
    IOUtils.writeFFTBenchmarkResultsToFile("benchmarkFloatForwardDST_2D_input_2D.txt", nthread, niter, doWarmup, doScaling, arrayOfInt, arrayOfDouble);
  }
  ...
  public static void benchmarkForward_3D_input_1D(int paramInt)
  {
    ...
    for (int i = 0; i < nsize; i++)
    {
      ...
      FloatDST_3D localFloatDST_3D = new FloatDST_3D(k, k, k);
      float[] arrayOfFloat = new float[k * k * k];
      if (doWarmup)
      {
        IOUtils.fillMatrix_3D(k, k, k, arrayOfFloat);
        localFloatDST_3D.forward(arrayOfFloat, false);
        IOUtils.fillMatrix_3D(k, k, k, arrayOfFloat);
        localFloatDST_3D.forward(arrayOfFloat, false);
      }
      float f = 0.0F;
    ...
    IOUtils.writeFFTBenchmarkResultsToFile("benchmarkFloatForwardDST_3D_input_1D.txt", nthread, niter, doWarmup, doScaling, arrayOfInt, arrayOfDouble);
  }
  ...
  public static void benchmarkForward_3D_input_3D(int paramInt)
  {
    ...
    IOUtils.writeFFTBenchmarkResultsToFile("benchmarkFloatForwardDST_3D_input_3D.txt", nthread, niter, doWarmup, doScaling, arrayOfInt, arrayOfDouble);
  }
 ...
 * Qualified Name:     edu.emory.mathcs.jtransforms.dst.BenchmarkFloatDST
