...
public class DoubleDCT_1D
{
  ...
  public DoubleDCT_1D(int paramInt, int[] paramArrayOfInt, double[] paramArrayOfDouble)
  {
    if (!ConcurrencyUtils.isPowerOf2(paramInt))
      throw new IllegalArgumentException("Dimension must be power of two");
    if (paramInt < 1)
  ...
  public void forward(double[] paramArrayOfDouble, int paramInt, boolean paramBoolean)
  {
    if (this.n == 1)
      return;
    int j = this.ip[0];
    ...
    {
      paramArrayOfDouble[(paramInt + i + 1)] = (paramArrayOfDouble[(paramInt + i)] - paramArrayOfDouble[(paramInt + i - 1)]);
      paramArrayOfDouble[(paramInt + i)] += paramArrayOfDouble[(paramInt + i - 1)];
    }
    paramArrayOfDouble[(paramInt + 1)] = (paramArrayOfDouble[paramInt] - d);
    paramArrayOfDouble[paramInt] += d;
    if (this.n > 4)
    {
      rftbsub(this.n, paramArrayOfDouble, paramInt, k, this.w, j);
      cftbsub(this.n, paramArrayOfDouble, paramInt, this.ip, j, this.w);
    }
    else if (this.n == 4)
    {
      cftbsub(this.n, paramArrayOfDouble, paramInt, this.ip, j, this.w);
    }
    dctsub(this.n, paramArrayOfDouble, paramInt, k, this.w, j);
    if (paramBoolean)
    {
      scale(paramArrayOfDouble, paramInt);
  ...
  public void inverse(double[] paramArrayOfDouble, int paramInt, boolean paramBoolean)
  {
    ...
    if (this.n > 4)
    {
      cftfsub(this.n, paramArrayOfDouble, paramInt, this.ip, j, this.w);
      rftfsub(this.n, paramArrayOfDouble, paramInt, k, this.w, j);
    }
    else if (this.n == 4)
    {
      cftfsub(this.n, paramArrayOfDouble, paramInt, this.ip, j, this.w);
    ...
    paramArrayOfDouble[(paramInt + this.n - 1)] = d;
  }
      ...
      if (i != j)
        arrayOfFuture[(i1++)] = ConcurrencyUtils.threadPool.submit(new Runnable()
        {
          public void run()
          {
            ...
            {
              m >>= 2;
              DoubleDCT_1D.this.cftmdl1(m, paramArrayOfDouble1, n - m, paramArrayOfDouble2, paramInt3 - (m >> 1));
            }
            DoubleDCT_1D.this.cftleaf(m, 1, paramArrayOfDouble1, n - m, paramInt3, paramArrayOfDouble2);
            int k = 0;
            int i1 = i3 - m;
            int j = i2 - m;
            while (j > 0)
            {
              k++;
              int i = DoubleDCT_1D.this.cfttree(m, j, k, paramArrayOfDouble1, i3, paramInt3, paramArrayOfDouble2);
              DoubleDCT_1D.this.cftleaf(m, i, paramArrayOfDouble1, i1 + j, paramInt3, paramArrayOfDouble2);
              j -= m;
            }
          }
        });
        ...
        arrayOfFuture[(i1++)] = ConcurrencyUtils.threadPool.submit(new Runnable()
        {
          public void run()
          {
            ...
            while (m > 512)
            {
              m >>= 2;
              k <<= 2;
              DoubleDCT_1D.this.cftmdl2(m, paramArrayOfDouble1, n - m, paramArrayOfDouble2, paramInt3 - m);
            }
            DoubleDCT_1D.this.cftleaf(m, 0, paramArrayOfDouble1, n - m, paramInt3, paramArrayOfDouble2);
            k >>= 1;
            int i1 = i3 - m;
            int j = i2 - m;
            while (j > 0)
  ...
  private void dctsub(int paramInt1, double[] paramArrayOfDouble1, int paramInt2, int paramInt3, double[] paramArrayOfDouble2, int paramInt4)
  {
    int i1 = paramInt1 >> 1;
    ...
    for (int i = 1; i < i1; i++)
    {
      ...
      int i3 = paramInt2 + i;
      int i4 = paramInt2 + j;
      double d1 = paramArrayOfDouble2[i2] - paramArrayOfDouble2[(paramInt4 + paramInt3 - k)];
      double d2 = paramArrayOfDouble2[i2] + paramArrayOfDouble2[(paramInt4 + paramInt3 - k)];
      double d3 = d2 * paramArrayOfDouble1[i3] - d1 * paramArrayOfDouble1[i4];
      paramArrayOfDouble1[i3] = (d1 * paramArrayOfDouble1[i3] + d2 * paramArrayOfDouble1[i4]);
      paramArrayOfDouble1[i4] = d3;
    }
    paramArrayOfDouble1[(paramInt2 + i1)] *= paramArrayOfDouble2[paramInt4];
  }

  private void scale(final double[] paramArrayOfDouble, final int paramInt)
  {
    int i = ConcurrencyUtils.getNumberOfProcessors();
    final double d = Math.sqrt(2.0D / this.n);
    ...
    else
    {
      ...
      {
        paramArrayOfDouble[localInterruptedException3] *= d;
        paramArrayOfDouble[(localInterruptedException3 + 1)] *= d;
      }
    }
  }
}
 ...
 * Qualified Name:     edu.emory.mathcs.jtransforms.dct.DoubleDCT_1D
