...
public class BenchmarkDoubleDCT
{
  ...
  public static void benchmarkForward_1D(int paramInt)
  {
    ...
    for (int i = 0; i < nsize; i++)
    {
      ...
      if (doWarmup)
      {
        ...
        localDoubleDCT_1D.forward(arrayOfDouble2, doScaling);
        IOUtils.fillMatrix_1D(k, arrayOfDouble2);
        localDoubleDCT_1D.forward(arrayOfDouble2, doScaling);
      }
      double d = 0.0D;
    ...
    IOUtils.writeFFTBenchmarkResultsToFile("benchmarkDoubleForwardDCT_1D.txt", nthread, niter, doWarmup, doScaling, arrayOfInt, arrayOfDouble1);
  }
  ...
  public static void benchmarkForward_2D_input_1D(int paramInt)
  {
    ...
    for (int i = 0; i < nsize; i++)
    {
      ...
      DoubleDCT_2D localDoubleDCT_2D = new DoubleDCT_2D(k, k);
      double[] arrayOfDouble2 = new double[k * k];
      if (doWarmup)
      {
        IOUtils.fillMatrix_2D(k, k, arrayOfDouble2);
        localDoubleDCT_2D.forward(arrayOfDouble2, doScaling);
        IOUtils.fillMatrix_2D(k, k, arrayOfDouble2);
        localDoubleDCT_2D.forward(arrayOfDouble2, doScaling);
      }
      double d = 0.0D;
    ...
    IOUtils.writeFFTBenchmarkResultsToFile("benchmarkDoubleForwardDCT_2D_input_1D.txt", nthread, niter, doWarmup, doScaling, arrayOfInt, arrayOfDouble1);
  }
  ...
  public static void benchmarkForward_2D_input_2D(int paramInt)
  {
    ...
    for (int i = 0; i < nsize; i++)
    {
      ...
      if (doWarmup)
      {
        ...
        localDoubleDCT_2D.forward(arrayOfDouble1, doScaling);
        IOUtils.fillMatrix_2D(k, k, arrayOfDouble1);
        localDoubleDCT_2D.forward(arrayOfDouble1, doScaling);
      }
      double d = 0.0D;
    ...
    IOUtils.writeFFTBenchmarkResultsToFile("benchmarkDoubleForwardDCT_2D_input_2D.txt", nthread, niter, doWarmup, doScaling, arrayOfInt, arrayOfDouble);
  }
  ...
  public static void benchmarkForward_3D_input_1D(int paramInt)
  {
    ...
    for (int i = 0; i < nsize; i++)
    {
      ...
      DoubleDCT_3D localDoubleDCT_3D = new DoubleDCT_3D(k, k, k);
      double[] arrayOfDouble2 = new double[k * k * k];
      if (doWarmup)
      {
        IOUtils.fillMatrix_3D(k, k, k, arrayOfDouble2);
        localDoubleDCT_3D.forward(arrayOfDouble2, doScaling);
        IOUtils.fillMatrix_3D(k, k, k, arrayOfDouble2);
        localDoubleDCT_3D.forward(arrayOfDouble2, doScaling);
      }
      double d = 0.0D;
    ...
    IOUtils.writeFFTBenchmarkResultsToFile("benchmarkDoubleForwardDCT_3D_input_1D.txt", nthread, niter, doWarmup, doScaling, arrayOfInt, arrayOfDouble1);
  }
  ...
  public static void benchmarkForward_3D_input_3D(int paramInt)
  {
    ...
    for (int i = 0; i < nsize; i++)
    {
      ...
      if (doWarmup)
      {
        ...
        localDoubleDCT_3D.forward(arrayOfDouble1, doScaling);
        IOUtils.fillMatrix_3D(k, k, k, arrayOfDouble1);
        localDoubleDCT_3D.forward(arrayOfDouble1, doScaling);
      }
      double d = 0.0D;
    ...
    IOUtils.writeFFTBenchmarkResultsToFile("benchmarkDoubleForwardDCT_3D_input_3D.txt", nthread, niter, doWarmup, doScaling, arrayOfInt, arrayOfDouble);
  }
 ...
 * Qualified Name:     edu.emory.mathcs.jtransforms.dct.BenchmarkDoubleDCT
