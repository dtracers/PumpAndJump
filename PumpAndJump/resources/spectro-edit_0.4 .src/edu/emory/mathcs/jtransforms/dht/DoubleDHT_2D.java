...
public class DoubleDHT_2D
{
  ...
  public void forward(double[] paramArrayOfDouble)
  {
    ...
    else
    {
      ...
      for (int n = 0; n < this.n1; n++)
        this.dhtn2.forward(paramArrayOfDouble, n * this.n2);
    }
  ...
  public void forward(double[][] paramArrayOfDouble)
  {
    ...
    else
    {
      ddxt2d_sub(-1, paramArrayOfDouble, true);
      for (int n = 0; n < this.n1; n++)
        this.dhtn2.forward(paramArrayOfDouble[n]);
    }
    y_transform(paramArrayOfDouble);
  }
  ...
  public void inverse(double[] paramArrayOfDouble, boolean paramBoolean)
  {
    ...
    else
    {
      ...
      for (int n = 0; n < this.n1; n++)
        this.dhtn2.inverse(paramArrayOfDouble, n * this.n2, paramBoolean);
    }
    y_transform(paramArrayOfDouble);
  }
  ...
  public void inverse(double[][] paramArrayOfDouble, boolean paramBoolean)
  {
    ...
    else
    {
      ddxt2d_sub(1, paramArrayOfDouble, paramBoolean);
      for (int n = 0; n < this.n1; n++)
        this.dhtn2.inverse(paramArrayOfDouble[n], paramBoolean);
    }
    y_transform(paramArrayOfDouble);
  }
    ...
    for (int k = 0; k < i; k++)
    {
      ...
      arrayOfFuture[k] = ConcurrencyUtils.threadPool.submit(new Runnable()
      {
        public void run()
        {
          ...
          int k;
          int m;
          if (DoubleDHT_2D.this.n2 > 2 * n)
          {
            if (paramInt == -1)
            {
              j = 4 * i1;
              while (j < DoubleDHT_2D.this.n2)
              {
                for (i = 0; i < DoubleDHT_2D.this.n1; i++)
                {
                  k = i * DoubleDHT_2D.this.n2 + j;
                  m = i2 + DoubleDHT_2D.this.n1 + i;
                  DoubleDHT_2D.this.t[(i2 + i)] = paramArrayOfDouble[k];
                  DoubleDHT_2D.this.t[m] = paramArrayOfDouble[(k + 1)];
                  DoubleDHT_2D.this.t[(m + DoubleDHT_2D.this.n1)] = paramArrayOfDouble[(k + 2)];
                  DoubleDHT_2D.this.t[(m + 2 * DoubleDHT_2D.this.n1)] = paramArrayOfDouble[(k + 3)];
                }
                DoubleDHT_2D.this.dhtn1.forward(DoubleDHT_2D.this.t, i2);
                DoubleDHT_2D.this.dhtn1.forward(DoubleDHT_2D.this.t, i2 + DoubleDHT_2D.this.n1);
                DoubleDHT_2D.this.dhtn1.forward(DoubleDHT_2D.this.t, i2 + 2 * DoubleDHT_2D.this.n1);
                DoubleDHT_2D.this.dhtn1.forward(DoubleDHT_2D.this.t, i2 + 3 * DoubleDHT_2D.this.n1);
                for (i = 0; i < DoubleDHT_2D.this.n1; i++)
                {
                  k = i * DoubleDHT_2D.this.n2 + j;
                  m = i2 + DoubleDHT_2D.this.n1 + i;
                  paramArrayOfDouble[k] = DoubleDHT_2D.this.t[(i2 + i)];
                  paramArrayOfDouble[(k + 1)] = DoubleDHT_2D.this.t[m];
                  paramArrayOfDouble[(k + 2)] = DoubleDHT_2D.this.t[(m + DoubleDHT_2D.this.n1)];
                  paramArrayOfDouble[(k + 3)] = DoubleDHT_2D.this.t[(m + 2 * DoubleDHT_2D.this.n1)];
                }
                j += 4 * n;
              }
            }
            ...
            while (j < DoubleDHT_2D.this.n2)
            {
              ...
              DoubleDHT_2D.this.dhtn1.inverse(DoubleDHT_2D.this.t, i2, paramBoolean);
              DoubleDHT_2D.this.dhtn1.inverse(DoubleDHT_2D.this.t, i2 + DoubleDHT_2D.this.n1, paramBoolean);
              DoubleDHT_2D.this.dhtn1.inverse(DoubleDHT_2D.this.t, i2 + 2 * DoubleDHT_2D.this.n1, paramBoolean);
              DoubleDHT_2D.this.dhtn1.inverse(DoubleDHT_2D.this.t, i2 + 3 * DoubleDHT_2D.this.n1, paramBoolean);
              for (i = 0; i < DoubleDHT_2D.this.n1; i++)
              {
                k = i * DoubleDHT_2D.this.n2 + j;
                m = i2 + DoubleDHT_2D.this.n1 + i;
          ...
          if (DoubleDHT_2D.this.n2 == 2 * n)
          {
            for (i = 0; i < DoubleDHT_2D.this.n1; i++)
            {
              k = i * DoubleDHT_2D.this.n2 + 2 * i1;
              m = i2 + i;
              DoubleDHT_2D.this.t[m] = paramArrayOfDouble[k];
              DoubleDHT_2D.this.t[(m + DoubleDHT_2D.this.n1)] = paramArrayOfDouble[(k + 1)];
            }
            if (paramInt == -1)
            {
              DoubleDHT_2D.this.dhtn1.forward(DoubleDHT_2D.this.t, i2);
            ...
            for (i = 0; i < DoubleDHT_2D.this.n1; i++)
            {
              k = i * DoubleDHT_2D.this.n2 + 2 * i1;
              m = i2 + i;
              paramArrayOfDouble[k] = DoubleDHT_2D.this.t[m];
              paramArrayOfDouble[(k + 1)] = DoubleDHT_2D.this.t[(m + DoubleDHT_2D.this.n1)];
            }
          }
          if (DoubleDHT_2D.this.n2 == n)
          {
            for (i = 0; i < DoubleDHT_2D.this.n1; i++)
              DoubleDHT_2D.this.t[(i2 + i)] = paramArrayOfDouble[(i * DoubleDHT_2D.this.n2 + i1)];
            if (paramInt == -1)
              DoubleDHT_2D.this.dhtn1.forward(DoubleDHT_2D.this.t, i2);
            else
              DoubleDHT_2D.this.dhtn1.inverse(DoubleDHT_2D.this.t, i2, paramBoolean);
            for (i = 0; i < DoubleDHT_2D.this.n1; i++)
              paramArrayOfDouble[(i * DoubleDHT_2D.this.n2 + i1)] = DoubleDHT_2D.this.t[(i2 + i)];
          }
        }
      });
    }
      ...
      arrayOfFuture[k] = ConcurrencyUtils.threadPool.submit(new Runnable()
      {
        public void run()
        {
          ...
          if (DoubleDHT_2D.this.n2 > 2 * n)
          {
            if (paramInt == -1)
            {
              ...
              while (j < DoubleDHT_2D.this.n2)
              {
                for (i = 0; i < DoubleDHT_2D.this.n1; i++)
                {
                  k = i2 + DoubleDHT_2D.this.n1 + i;
                  DoubleDHT_2D.this.t[(i2 + i)] = paramArrayOfDouble[i][j];
                  DoubleDHT_2D.this.t[k] = paramArrayOfDouble[i][(j + 1)];
                  DoubleDHT_2D.this.t[(k + DoubleDHT_2D.this.n1)] = paramArrayOfDouble[i][(j + 2)];
                  DoubleDHT_2D.this.t[(k + 2 * DoubleDHT_2D.this.n1)] = paramArrayOfDouble[i][(j + 3)];
                }
                DoubleDHT_2D.this.dhtn1.forward(DoubleDHT_2D.this.t, i2);
                DoubleDHT_2D.this.dhtn1.forward(DoubleDHT_2D.this.t, i2 + DoubleDHT_2D.this.n1);
                DoubleDHT_2D.this.dhtn1.forward(DoubleDHT_2D.this.t, i2 + 2 * DoubleDHT_2D.this.n1);
                ...
                {
                  k = i2 + DoubleDHT_2D.this.n1 + i;
                  paramArrayOfDouble[i][j] = DoubleDHT_2D.this.t[(i2 + i)];
                  paramArrayOfDouble[i][(j + 1)] = DoubleDHT_2D.this.t[k];
                  paramArrayOfDouble[i][(j + 2)] = DoubleDHT_2D.this.t[(k + DoubleDHT_2D.this.n1)];
                  paramArrayOfDouble[i][(j + 3)] = DoubleDHT_2D.this.t[(k + 2 * DoubleDHT_2D.this.n1)];
                }
                j += 4 * n;
              }
            }
          ...
          if (DoubleDHT_2D.this.n2 == 2 * n)
          {
            ...
            {
              k = i2 + i;
              DoubleDHT_2D.this.t[k] = paramArrayOfDouble[i][(2 * i1)];
              DoubleDHT_2D.this.t[(k + DoubleDHT_2D.this.n1)] = paramArrayOfDouble[i][(2 * i1 + 1)];
            }
            if (paramInt == -1)
            {
              DoubleDHT_2D.this.dhtn1.forward(DoubleDHT_2D.this.t, i2);
            ...
            {
              k = i2 + i;
              paramArrayOfDouble[i][(2 * i1)] = DoubleDHT_2D.this.t[k];
              paramArrayOfDouble[i][(2 * i1 + 1)] = DoubleDHT_2D.this.t[(k + DoubleDHT_2D.this.n1)];
            }
          }
          if (DoubleDHT_2D.this.n2 == n)
          {
            for (i = 0; i < DoubleDHT_2D.this.n1; i++)
              DoubleDHT_2D.this.t[(i2 + i)] = paramArrayOfDouble[i][i1];
            if (paramInt == -1)
              DoubleDHT_2D.this.dhtn1.forward(DoubleDHT_2D.this.t, i2);
            else
              DoubleDHT_2D.this.dhtn1.inverse(DoubleDHT_2D.this.t, i2, paramBoolean);
            for (i = 0; i < DoubleDHT_2D.this.n1; i++)
              paramArrayOfDouble[i][i1] = DoubleDHT_2D.this.t[(i2 + i)];
          }
        }
      });
    }
    ...
    for (int j = 0; j < i; j++)
    {
      ...
      arrayOfFuture[j] = ConcurrencyUtils.threadPool.submit(new Runnable()
      {
        public void run()
        {
          ...
          {
            i = m;
            while (i < DoubleDHT_2D.this.n1)
            {
              DoubleDHT_2D.this.dhtn2.forward(paramArrayOfDouble, i * DoubleDHT_2D.this.n2);
              i += i;
            }
          }
          else
          {
            ...
            while (i < DoubleDHT_2D.this.n1)
            {
              DoubleDHT_2D.this.dhtn2.inverse(paramArrayOfDouble, i * DoubleDHT_2D.this.n2, paramBoolean);
              i += i;
            }
          }
        }
      ...
      arrayOfFuture[j] = ConcurrencyUtils.threadPool.submit(new Runnable()
      {
        public void run()
        {
          ...
          if (paramInt == -1)
          {
            ...
            while (i < DoubleDHT_2D.this.n1)
            {
              DoubleDHT_2D.this.dhtn2.forward(paramArrayOfDouble[i]);
              i += i;
            }
          }
          else
          {
            ...
            while (i < DoubleDHT_2D.this.n1)
            {
              DoubleDHT_2D.this.dhtn2.inverse(paramArrayOfDouble[i], paramBoolean);
              i += i;
            }
          }
        }
  ...
  private void y_transform(double[] paramArrayOfDouble)
  {
    for (int k = 0; k <= this.n1 / 2; k++)
      for (int m = 0; m <= this.n2 / 2; m++)
      {
        ...
        double d1 = paramArrayOfDouble[(k * this.n2 + m)];
        double d2 = paramArrayOfDouble[(i * this.n2 + m)];
        double d3 = paramArrayOfDouble[(k * this.n2 + j)];
        double d4 = paramArrayOfDouble[(i * this.n2 + j)];
        double d5 = (d1 + d4 - (d2 + d3)) / 2.0D;
        paramArrayOfDouble[(k * this.n2 + m)] = (d1 - d5);
        paramArrayOfDouble[(i * this.n2 + m)] = (d2 + d5);
        paramArrayOfDouble[(k * this.n2 + j)] = (d3 + d5);
        paramArrayOfDouble[(i * this.n2 + j)] = (d4 - d5);
      }
  }
  ...
  private void y_transform(double[][] paramArrayOfDouble)
  {
    for (int k = 0; k <= this.n1 / 2; k++)
      for (int m = 0; m <= this.n2 / 2; m++)
      {
        int i = (this.n1 - k) % this.n1;
        int j = (this.n2 - m) % this.n2;
        double d1 = paramArrayOfDouble[k][m];
        double d2 = paramArrayOfDouble[i][m];
        double d3 = paramArrayOfDouble[k][j];
        double d4 = paramArrayOfDouble[i][j];
        double d5 = (d1 + d4 - (d2 + d3)) / 2.0D;
        paramArrayOfDouble[k][m] = (d1 - d5);
        paramArrayOfDouble[i][m] = (d2 + d5);
 ...
 * Qualified Name:     edu.emory.mathcs.jtransforms.dht.DoubleDHT_2D
